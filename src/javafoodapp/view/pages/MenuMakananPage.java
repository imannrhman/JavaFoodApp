 ...
 * @author imannrhman
 */
public class MenuMakananPage extends javax.swing.JPanel {
    ...
    public MenuMakananPage(JPanel panel) {
        initComponents();
        mainPanel = panel;
    ...
    private void initComponents() {
        ...
        titleLabel.setText("Tabel Menu Makanan");
    ...
    private void tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahActionPerformed
        mainPanel.removeAll();
        mainPanel.add(new MenuMakanForm(mainPanel, null));
        mainPanel.repaint();
