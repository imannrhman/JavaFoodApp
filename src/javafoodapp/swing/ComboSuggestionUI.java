...
public class ComboSuggestionUI extends BasicComboBoxUI {
    ...
    public void installUI(JComponent jc) {
        ...
        txt.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent fe) {
                border.setColor(new Color(75, 175, 152));
            }
        ...
        txt.setSelectionColor(new Color(75, 175, 152));
        txt.setBorder(new EmptyBorder(10, 4, 0, 10));
        txt.setBackground(new Color(75, 175, 152));
    ...
    protected ListCellRenderer createRenderer() {
        return new ListCellRenderer() {
            ...
            public Component getListCellRendererComponent(JList jlist, Object e, int i, boolean bln, boolean bln1) {
                ...
                if (i >= 0) {
                    label.setBorder(new EmptyBorder(10, 8, 8, 10));
                } else {
                ...
                if (bln) {
                    ...
                    label.setForeground(new Color(75, 175, 152));
                }
                return label;
            }
        };
    ...
    private class Border extends EmptyBorder {
        ...
        private Color focusColor = new Color(75, 175, 152);
